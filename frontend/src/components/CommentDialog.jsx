...
const CommentDialog = ({ open, setOpen }) => {
    ...
    const sendMessageHandler = async () => {
        try {
            const res = await axios.post(`https://instaclone-cy5z.onrender.com/api/v1/post/${selectedPost._id}/comment`, { text }, {
                headers: {
    ...
    return (
        <Dialog open={open}>
            <DialogContent onInteractOutside={() => setOpen(false)} className='w-full max-w-5xl p-0 flex flex-col'>
